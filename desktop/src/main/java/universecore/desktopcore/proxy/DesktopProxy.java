package universecore.desktopcore.proxy;
...
public class DesktopProxy<Target> extends BaseProxy<Target>{
  ...
  public DesktopProxy(Class<Target> clazz, AbstractFileClassLoader loader, ClassLoader modClassLoader, DesktopClassHandler handler){
