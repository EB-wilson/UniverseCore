...
public class AndroidMethodInvokeHelper26 implements MethodInvokeHelper{
  private static final ObjectMap<Class<?>, ObjectMap<String, ObjectMap<FunctionType, MethodHandle>>> methodPool = new ObjectMap<>();
  private static final ObjectMap<Method, MethodHandle> metMap = new ObjectMap<>();
