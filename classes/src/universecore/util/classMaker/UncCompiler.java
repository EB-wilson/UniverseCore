...
public class UncCompiler{
  ...
  private static final UncJavaFileManager manager = new UncJavaFileManager(nativeCompiler.getStandardFileManager(collector, null, null));
  ...
  public byte[] compileToByteCode(String fullClassName, String sourceCode){
