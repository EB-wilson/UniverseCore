...
public abstract class AbstractAspect<Type, Source> implements Iterable<Type>{
  ...
  protected Cons<Type> entry;
  protected Cons<Type> exit;
  ...
  public AbstractAspect<Type, Source> setEntryTrigger(Cons<Type> entry){
    this.entry = entry;
    return this;
  }
  ...
  public AbstractAspect<Type, Source> setExitTrigger(Cons<Type> exit){
    this.exit = exit;
    return this;
  }
  ...
  public void remove(Type removed){
    if(children.remove(removed)) exit.get(removed);
  }
