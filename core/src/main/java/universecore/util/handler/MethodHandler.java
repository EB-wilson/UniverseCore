...
public class MethodHandler<T>{
  ...
  public <R> R invoke(T object, String name, Object... args){
    return UncCore.methodInvokeHelper.invoke(object, name, args);
  }
  ...
  public <R> R invokeStatic(String name, Object... args){
    return UncCore.methodInvokeHelper.invokeStatic(clazz, name, args);
  }
  ...
  public T newInstance(Object... args){
    return UncCore.methodInvokeHelper.newInstance(clazz, args);
  }
